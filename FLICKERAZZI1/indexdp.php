...
<section id="hindi">
  ...
  <div class="tamil-movies">
    ...
    <div class="movies-list">
      ...
      <div class="tamil-movie" movie_id="7" onclick="openModal('thambi1.jpeg', 'THAMBI', 'Thambi is a visually stunning film that combines great direction with a compelling story. The film’s excellent production values and performances are noteworthy.')">
  ...
  <div class="modal" id="movieModal">
    <div class="modal-content">
      ...
      <div class="comment-section">
        <h3>Comments</h3>
        <form action="indexdp.php" id="commentForm">
...
function fetchComments() {
    fetch('indexdp.php?fetch_comments=true')
        .then(response => response.text())
        .then(data => {
