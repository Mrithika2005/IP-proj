  ...
  <div class="main-content">
    <div class="slider">
      <div class="slider-container">
        <img src="love next door.jpg" alt="Movie 1" onclick="openModal('love next door.jpg', 'LOVE NEXT DOOR', 'This is a review for Love Next Door. It is an engaging film that captivates the audience with its storyline and characters. The cinematography and acting are top-notch, making it a must-watch for movie enthusiasts.', '1','https://youtu.be/VHpIfbxKCzI?si=ZGbutkyIkTB2YGOY')">
...
function prevSlide() {
  ...
  showSlides();
    ...
    function openModal(imageSrc, title, description, movieId,link) {
